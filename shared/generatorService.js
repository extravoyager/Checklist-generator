// Deterministic local checklist generator. Pure, no UI/DB deps.
// Inputs: { title, industry, siteType, objective, riskFocus[], criticalControls[],
//          depth, sections, questionsPerSection, scoringOn, evidenceRequired, autoActions }
